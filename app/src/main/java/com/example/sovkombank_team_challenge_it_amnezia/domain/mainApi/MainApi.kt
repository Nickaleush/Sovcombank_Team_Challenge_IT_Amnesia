...
interface MainApi {
    ...
    @POST("api/account/transaction/buy")
    fun createBuyTransaction(@Body transaction: Transaction): Single<Unit>

    @POST("api/account/transaction/sell")
    fun createSellTransaction(@Body transaction: Transaction): Single<Unit>
