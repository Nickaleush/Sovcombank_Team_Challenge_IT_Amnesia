...
class ClientListActiveAdapter (private val activeClientsList: ArrayList<Client>) : RecyclerView.Adapter<ClientListActiveAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        v.firstNameTextview.text = item.firstName
